        # Pubbiassuite: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/pubbiassuite.git

        ## Objective

        PubBiasSuite provides 12 publication bias detection methods and three funnel plot variants in a single browser-based tool, with comparative method performance reporting.
        ...
        - Code: https://github.com/mahmood726-cyber/pubbiassuite.git
        - Dashboard: https://mahmood726-cyber.github.io/pubbiassuite/
